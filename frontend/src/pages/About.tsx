    ...
    <div class="max-w-4xl mx-auto py-8 space-y-8">
      ...
      <div class="prose dark:prose-invert max-w-none">
        <p class="text-lg text-gray-600 dark:text-gray-300 mb-6">
          YT Music Spotify Linker is a powerful tool that helps you seamlessly
          synchronize your music playlists between YouTube Music and Spotify,
          eliminating the hassle of manually recreating playlists across
          platforms.
        </p>
        ...
        <ul class="list-disc list-inside space-y-2 text-gray-600 dark:text-gray-300 mb-6">
          <li>
            Automatic playlist synchronization between YouTube Music and Spotify
          </li>
        ...
        <p class="text-gray-600 dark:text-gray-300">
          Your privacy is our priority. We use secure OAuth protocols to connect
          to your music accounts and never store your passwords. All data is
          encrypted and your playlist information is only used for
