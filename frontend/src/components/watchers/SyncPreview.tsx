...
export const SyncPreview: Component<SyncPreviewProps> = (props) => {
  const [previewData, setPreviewData] = createSignal<SyncPreviewType | null>(null);
      ...
      >
        ...
        >
          ...
          <div class="flex items-center justify-between p-6 border-b border-gray-200 dark:border-gray-600">
            <h2 id="preview-modal-title" class="text-xl font-semibold text-gray-900 dark:text-gray-50">
                ...
                <div class="p-8">
                  ...
                  >
                    <div class="text-center py-12">
                      ...
                      <Button variant="secondary" size="sm" onClick={loadPreviewData}>
                        Retry
                      </Button>
                    </div>
                  </Show>
                ...
                <div class="p-6">
                  ...
                  <div class="mb-6 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                    ...
                    <div class="mt-4 text-sm text-gray-600 dark:text-gray-400 text-center">
                      <strong>From:</strong> {data().sourcePlaylist} → <strong>To:</strong> {data().targetPlaylist}
                    </div>
                  </div>
                  ...
                  <div class="space-y-2">
                    ...
                    >
                      <div class="max-h-96 overflow-y-auto space-y-2">
                        <For each={data().items}>
                          {(item) => (
                            <div class={`flex items-center space-x-3 p-3 rounded-lg border ${getActionColor(item.action)}`}>
